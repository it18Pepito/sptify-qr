...
<head>
    ...
    <link rel="icon" type="image/webp" href="/assets/pepi-plus-logo.webp">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="logo">
            <img src="/assets/pepi-plus-logo.webp" alt="Pepi Plus Logo">
        </div>
        ...
        <div class="store-buttons">
            <a href="https://apps.apple.com/id/app/pepi-plus/id6752885751" class="store-button app-store-btn"
                target="_blank">
                <img src="/assets/apple-logo.png" style="width: 24px" />
            ...
            <a href="https://play.google.com/store/apps/details?id=id.loyal.pepito&pcampaignid=web_share"
                ...
                <img src="/assets/playstore-logo.png" style="width: 24px" />
                <div class="button-text">
